  ...
  SupportsInterface
{
    ...
    */
    ...
    /** 
    * @dev Mapping from tokenID to the addresses whitelisted by the token owner
    */
    mapping(uint256 => address[]) public invitees;

    /**
    * @dev Mapping from tokenID to the addresses signed by the whitelisted addresses
    */
    ...
    */
    ...
    /**
    * @dev Allows signing of the NFT
    * @param _tokenId ID of the NFT
    * @param _index Index at which the whitlisted address resides in signeeAddress mapping
    */
    function sign(uint256 _tokenId, uint256 _index) external validNFToken(_tokenId){
        address signeeAddress  = invitees[_tokenId][_index];
        require(msg.sender == signeeAddress);
        require(_index < invitees[_tokenId].length);
